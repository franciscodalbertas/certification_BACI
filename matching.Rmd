...
>>>>>>> 3ce0720249b4188021fbd9d04c1b29ed9c931b4b
```
...
nn_ma <-matchit(formula, data=df_ma, method="nearest", ratio=1, caliper = 0.2)
...
nn_ce <-matchit(formula, data=df_ce, method="nearest", ratio=1, caliper = 0.25)
