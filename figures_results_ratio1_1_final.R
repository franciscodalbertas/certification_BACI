...
apps <- st_read(file.path("G:/Meu Drive/conteudo_notedell/Doutorado/cap3",
...
write.csv(tabela_ma_def_1,"tables/def_ma_pd_ratio_1_1.csv",row.names = F)
...
write.csv(tabela_ce_def_1,"tables/def_ce_pd_ratio_1_1.csv",row.names = F)
